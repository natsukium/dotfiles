...
in
{
  xdg.configFile."sketchybar/sketchybarrc" = {
    source = pkgs.substituteAll {
      src = ./sketchybarrc;
      inherit lua;
      inherit (nurpkgs) sbarlua;
    };
    executable = true;
  };
  xdg.configFile."sketchybar/bar.lua".source = ./bar.lua;
  ...
  xdg.configFile."sketchybar/default.lua".source = ./default.lua;
  xdg.configFile."sketchybar/icons.lua".source = ./icons.lua;
  ...
  xdg.configFile."sketchybar/settings.lua".source = ./settings.lua;
