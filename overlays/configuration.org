...
The patch is the upstream fix, which retries without the reasoning fields after a 400
or 422. It landed after 0.9.4, so this goes away once nixpkgs ships a release carrying
it.
