...
(function () {
  ...
  // The heading's own words: no section number, and no trailing "#" from the
  // self link. Stripping them from a clone rather than from the text keeps a
  // heading that happens to contain those characters intact.
  function crumbLabel(h) {
    var clone = h.cloneNode(true);
    var drop = clone.querySelectorAll('[class^="section-number-"], .heading-anchor');
