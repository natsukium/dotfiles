{ config, pkgs, ... }:
{
  my.services.hammerspoon = {
    enable = true;
    configFile = config.lib.file.mkOutOfStoreSymlink "${config.programs.git.settings.ghq.root}/github.com/natsukium/dotfiles/modules/home/desktop/hammerspoon/init.lua";
    spoons = [
