...
Firefox. Both browsers stay installed for now, sharing one set of search engines
and extensions.

#+begin_src nix :tangle features/firefox/default.nix :exports none
# This file is auto-generated from configuration.org.
# Do not edit directly.
#+end_src

#+begin_src nix :tangle features/firefox/default.nix
{ ... }:
let
...
Zen ships its own home-manager module in its flake, so mine only imports it and
fills in the shared profile pieces.

It never got along with Nix on darwin: with home-manager managing its profiles,
launch kept ending in an error loop at the profile chooser, and the app bundle's
code signature makes it hard to build in the Nix sandbox.

#+NAME: zen-browser-module
#+begin_src nix
...
Zen is a Firefox fork, so the preferences that are not about parfait carry over
unchanged, for the reasons given in the Firefox profile.
...
first. Both browser profiles take this file, so an alias means the same thing
whichever one is open.

#+begin_src nix :tangle features/firefox/search.nix :exports none
# This file is auto-generated from configuration.org.
# Do not edit directly.
#+end_src

#+begin_src nix :tangle features/firefox/search.nix
{ pkgs }:
{
  force = true;
  engines = {
...
#+begin_src nix :tangle features/firefox/extensions.nix :exports none
# This file is auto-generated from configuration.org.
# Do not edit directly.
#+end_src

#+begin_src nix :tangle features/firefox/extensions.nix
{ pkgs }:
{
  packages =
